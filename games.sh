...
apt update
apt -y install widelands vegastrike-data 0ad freeciv-client-gtk freeciv-server asylum xmoto warzone2100 fretsonfire scorched3d warmux quake quake2 quake3 extremetuxracer alien-arena wesnoth nexuiz
apt-get clean
exit 0
